...
/** @nocollapse */
MaterialWrapperModule.ctorParameters = () => [];

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes} checked by tsc
 */
class RdAngularWrapperModule {
}
...
/** @nocollapse */
RdAngularWrapperModule.ctorParameters = () => [];
 ...
 */
class BlockedApptTimeOverviewExample {
    constructor() {
        this.states = [
            {
                name: 'Arkansas',
...
/** @nocollapse */
BlockedApptTimeOverviewExample.ctorParameters = () => [];
